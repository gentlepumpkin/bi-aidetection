...
namespace NPushover.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushoverException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PushoverException"/> class with a specified error message and
